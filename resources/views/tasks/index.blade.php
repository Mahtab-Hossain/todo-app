<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg {{ Cookie::get('theme', 'light') === 'dark' ? 'bg-gray-800 text-white' : 'bg-white text-gray-900' }}">
                <div class="p-6">
                    <div class="flex justify-between items-center mb-6">
                        <h1 class="text-2xl font-bold">To-Do List</h1> <!-- Optional: Remove if you don't want duplicate title -->
                    ...
                    <table class="w-full border-collapse">
                        <thead>
                            <tr class="bg-gray-200 {{ Cookie::get('theme', 'light') === 'dark' ? 'bg-gray-700' : 'bg-gray-200' }}">
                                <th class="p-2">ID</th>
